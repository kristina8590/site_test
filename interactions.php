...
?>
   ...
   <div class="container mt-4">
     <div class="row">
       ...
       <div class="col-md-4">
         <img src="images/1.jpg" class="img-fluid drag" alt="Priroda">
       </div>
       <div class="col-md-4">
         <img src="images/2.jpg" class="img-fluid drag" alt="Priroda">
       </div>
       <div class="col-md-4">
         <img src="images/3.jpg" class="img-fluid drag" alt="Priroda">
       </div>
     </div>
   </div>
<div class="container mt-4">
     <div class="row">
       ...
       <div class="col-md-8">
         <img src="images/1.jpg" class="drag1" width="200" alt="Priroda">
         <img src="images/2.jpg" class="drag1" width="200" alt="Priroda">
         <img src="images/3.jpg" class="drag1" width="200" alt="Priroda">
       </div>
       <div class="col-md-4">
         <img src="images/trashcan-empty-icon.png" class="trash ml-4" alt="Korzina">
       </div>
     </div>
   </div>  
   <div class="container mt-4">
     ...
     <div class="row">
       ...
       <div class="col-md-4">
         <div class="card resize">
           ...
           <div class="card-body">
             <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ea nihil modi nulla libero, rem, consequuntur reiciendis voluptas debitis vel facilis, error dolorem in ut ipsa praesentium laudantium dignissimos, saepe quidem.</p>
           </div>
         </div>
       </div>
     </div>
